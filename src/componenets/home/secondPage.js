                        ...
                        <Slider   {...settings}>
                            ...
                            <div className="card portfolioCard">
                                ...
                                <div className="card-body">
                                    ...
                                    <p  style={{fontFamily: "'Source Sans Pro', sans-serif"}} className="card-text pfText text-justify">A website that allows a show to sell products online. It's based on meteor with a custom interface to add,delete and modify items in the apollo server.</p>
